...
using Xabe.FFmpeg;
using MR.VideoTranscriberApp.BlazorUI.Client.Models;

namespace MR.VideoTranscriberApp.BlazorUI.Services
{
    public class TranscriptionManager
    {
        ...
        public TranscriptionManager(IWebHostEnvironment environment, IOpenAIService openAiService)
        {
            _environment = environment;
            _openAiService = openAiService;
        }

        public async Task<List<TranscriptionModel>> UploadAsync(VideoUploadRequest request,
